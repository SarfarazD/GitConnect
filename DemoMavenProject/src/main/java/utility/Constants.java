...
public class Constants 
{
	...
	*/
		...
		public static final String LoginPage_CM = ApplicationURL + "/login";
		public static final String CT_Username = GetPropertyValue("CT_Username");
		public static final String CT_Password = GetPropertyValue("CT_Password");
